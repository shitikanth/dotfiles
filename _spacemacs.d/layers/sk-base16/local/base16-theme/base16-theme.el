...
;;;; cider-mode
     (cider-test-success-face                      :foreground base00 :background base0B)
     (cider-test-failure-face                      :foreground base00 :background base08)
;;;; clojure-mode
...
;;;; man-mode
     (Man-overstrike :foreground base0C)
     (Man-underline  :foreground base0A)
...
;;;; neotree
     (neo-banner-face :foreground base0C :weight bold)
     (neo-button-face :foreground base03)
     (neo-dir-link-face :foreground base0D :weight bold)
     (neo-expand-btn-face :inherit neo-button-face)
     (neo-file-link-face :foreground base05)
     (neo-header-face :foreground base07)
     (neo-root-dir-face :foreground base0E :weight bold)
     (neo-vc-added-face :foreground base0B)
     (neo-vc-conflict-face :foreground base08)
     (neo-vc-default-face :foreground base07)
     (neo-vc-edited-face :foreground base0E)
     (neo-vc-ignored-face :foreground base04)
     (neo-vc-missing-face :foreground base08)
     (neo-vc-needs-merge-face :foreground base08)
     (neo-vc-needs-update-face :foreground base05 :underline t)
     (neo-vc-removed-face :foreground base05 :strike-through t)
     (neo-vc-unlocked-changes-face :foreground base0C)
     (neo-vc-unregistered-face :foreground base0C)
     (neo-vc-up-to-date-face :foreground base07)
...
;;;; org-mode
     ...
     (org-document-info                            :foreground base05)
     ...
     (org-kbd                                      :background base01 :foreground base05)
...
;;;; w3m-mode
     ...
     (w3m-tab-background :background base00 :foreground base05)
